...
#include "src/TinyStepper_28BYJ_48/src/TinyStepper_28BYJ_48.h"    //步进电机的库 如果没有该lib请按Ctrl+Shift+I 从 库管理器中搜索 Stepper_28BYJ_48，并安装
...
void loop() {
 //注意卡上的文件名要和程序一致。！！！！！
  ...
  drawfile("shield.nc");  //1.nc 是Gcode代码的文件名 ，需要将g代码保存在sd卡上。
